...
public class ReadExcelData {
	...
	static String filePath = "C:\\Users\\moham\\eclipse-workspace\\Never_Stop\\TestData\\Read Excel TestData.xlsx";
@Test
	public static void getEXcelData() throws IOException {
		...
		// I have to use XSSFWorkbook class from ApachePOI to create the object and pass
		// the parameter
		...
		// I go through the iterator creating object to go through all the sheet value
		// and
		...
		while (rowIterator.hasNext()) {
			...
			System.out.println("This is Excel data: "+list);
		}
	}
